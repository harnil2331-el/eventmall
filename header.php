...
<html lang="en" dir="ltr">
  ...
  <body  style="top:0;left:0;background-image:url(main.jpg);height:100%;width:100%;">
    <header>

      <nav class="navbar navbar-expand-lg bg-dark navbar-dark fixed-top">
      <div class="container" style="font-size:17px;">
        <!-- Brand -->
        <a class="navbar-brand" href="index.php"><img src="1.png" height="35" width="35">Event Mall</a>
                ...
                <ul class="navbar-nav ml-auto">
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                      ...
                      <a class="dropdown-item" href="slogin.php">Stakeholder</a>
                    </div>
                  </li>
                  <li class="nav-item dropdown">
                          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          ...
                          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="ssignup.php">Stakeholder</a>
                          </div>
                  </li>
                </ul>
                ';
